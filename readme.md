...
Make and checkout a feature branch. Make a change to branching.txt and commit git branch feature
...
Switch back to master and make a change to branching.txt On master, change the first line
